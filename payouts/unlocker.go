...
//const diffAdjustExtForkHeight = 2447818
const diffAdjustExtForkHeight = 400

var homesteadReward = math.MustParseBig256("209356000000000000000")
var byzantiumReward = math.MustParseBig256("209356000000000000000")
var diffAdjustExtReward = math.MustParseBig256("157017000000000000000")
...
func NewBlockUnlocker(cfg *UnlockerConfig, backend *storage.RedisClient) *BlockUnlocker {
	...
	u.rpc, _ = rpc.NewRPCClient("BlockUnlocker", cfg.Daemon, cfg.Timeout)
	return u
}
 ...
 * ISSUE: https://xcoin/HayekPool/issues/2333
 */
...
func matchCandidate(block *rpc.GetBlockReply, candidate *storage.BlockData) bool {
	...
	// Parity's EIP: https://xcoin/HayekPool/EIPs/issues/95
...
func getConstReward(height int64) *big.Int {
	if true {
		// 选择 QKC 的减半策略
		return GetConstReward_qkc(height)
	}

	if height >= diffAdjustExtForkHeight {
		return new(big.Int).Set(diffAdjustExtReward)
	}
