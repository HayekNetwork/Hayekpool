...
func _TestGetUncleReward(t *testing.T) {
...
func _TestGetByzantiumUncleReward(t *testing.T) {
	rewards := make(map[int64]string)
	expectedRewards := map[int64]string{
...
func _TestGetRewardForUngle(t *testing.T) {
...
func _TestGetByzantiumRewardForUngle(t *testing.T) {
